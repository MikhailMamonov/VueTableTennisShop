    ...
    return new Vuex.Store({
      state: {
        products : [
          //Накладки
          //butterfly
            {id:1, category:2, brand:2, label: "Tenegry", image:"https://www.vistasport.ru/upload/iblock/bf9/bf9c3fc0f9cac3c4357617663c5dc3db.jpg", description: descriptionValue},
            {id:2, category:2, brand:2, label: "Sriver", image:"https://www.vistasport.ru/upload/iblock/503/503d1f2951107d75db50d7ef12f47439.jpg", description:descriptionValue},
            {id:3, category:2, brand:2, label: "Omega", image:"https://www.vistasport.ru/upload/iblock/503/503d1f2951107d75db50d7ef12f47439.jpg", description: descriptionValue},
            {id:4, category:2, brand:2, label: "Vega", image:"https://www.vistasport.ru/upload/iblock/503/503d1f2951107d75db50d7ef12f47439.jpg", description: descriptionValue},
            {id:5, category:2, brand:2, label: "802-40", image:"https://www.vistasport.ru/upload/iblock/888/888f55921f38ee87a093231bbe051cc7.png", description: descriptionValue},
            {id:6, category:2, brand:2, label: "Rakza", image:"https://www.vistasport.ru/upload/iblock/503/503d1f2951107d75db50d7ef12f47439.jpg", description: descriptionValue},
            //xiom
            ...
            {id:8, category:1, brand:2, label: "Mazutani", image:"https://www.vistasport.ru/upload/iblock/503/503d1f2951107d75db50d7ef12f47439.jpg", description: descriptionValue},
            {id:9, category:1, brand:2, label: "Ma Lin", image:"https://www.vistasport.ru/upload/iblock/503/503d1f2951107d75db50d7ef12f47439.jpg", description: descriptionValue},
            {id:10, category:1, brand:2, label: "Ovcharov", image:"https://www.vistasport.ru/upload/iblock/503/503d1f2951107d75db50d7ef12f47439.jpg", description: descriptionValue},
            {id:11, category:1, brand:5, label: "Hurricane", image:"https://www.vistasport.ru/upload/iblock/965/96578dc0b3a68d18aedff687333322d7.jpg", description: descriptionValue},
            {id:12, category:1, brand:2, label: "ZhangJike", image:"https://www.vistasport.ru/upload/iblock/503/503d1f2951107d75db50d7ef12f47439.jpg", description: descriptionValue},
            {id:13, category:1, brand:5, label: "Ma Long", image:"https://www.vistasport.ru/upload/iblock/c4d/c4d4ef5b2f98889626b94676f7db7678.jpg", description: descriptionValue},
            {id:14, category:1, brand:2, label: "Harimoto", image:"https://www.vistasport.ru/upload/iblock/503/503d1f2951107d75db50d7ef12f47439.jpg", description: descriptionValue},
            //friendship
            {id:15, category:3, brand:8,label: "Radiall", image:"https://www.vistasport.ru/upload/iblock/ea6/ea6f17a7e8526a6ff4c4689a1c158f6c.jpg", description: descriptionValue},
            {id:16, category:3, brand:2, label: "Cross", image:"https://www.vistasport.ru/upload/iblock/503/503d1f2951107d75db50d7ef12f47439.jpg", description: descriptionValue},
            {id:17, category:3, brand:8,label: "enerforce", image:"https://www.vistasport.ru/upload/iblock/ec0/ec0db1dcc697374ea144ade8d25738e8.jpg", description: descriptionValue},
            {id:18, category:3, brand:2, label: "rerte", image:"https://www.vistasport.ru/upload/iblock/503/503d1f2951107d75db50d7ef12f47439.jpg", description: descriptionValue},
            {id:19, category:3, brand:8,label: "runner", image:"https://www.vistasport.ru/upload/iblock/6fe/6fede4d7116ea87f086ce0edd2e57bf9.jpg", description: descriptionValue},
            {id:20, category:3, brand:2, label: "asics", image:"https://www.vistasport.ru/upload/iblock/503/503d1f2951107d75db50d7ef12f47439.jpg", description: descriptionValue},
            //Основания
            {id:21, category:4, brand:2,label: "Donic Persson", image:"https://www.vistasport.ru/upload/iblock/395/395478a9408cfee7da20bd147f02b89e.jpg", description: descriptionValue},
            {id:22, category:4, brand:2, label: "Donic Waldner", image:"https://www.vistasport.ru/upload/iblock/503/503d1f2951107d75db50d7ef12f47439.jpg", description: descriptionValue},
            {id:23, category:4, brand:7,label: "Dhs", image:"https://www.vistasport.ru/upload/iblock/387/387de1507249d6e6bc8672176376ee08.jpg", description: descriptionValue},
            {id:24, category:4, brand:2, label: "Cornelio", image:"https://www.vistasport.ru/upload/iblock/503/503d1f2951107d75db50d7ef12f47439.jpg", description: descriptionValue},
            {id:25, category:4, brand:4,label: "StarLine", image:"https://www.vistasport.ru/upload/iblock/7ff/7ff6cd47ec83e24c1b3d32c7c06f2074.jpg", description: descriptionValue},
            {id:26, category:4, brand:2, label: "Stiga", image:"https://www.vistasport.ru/upload/iblock/503/503d1f2951107d75db50d7ef12f47439.jpg", description: descriptionValue},
            {id:27, category:4, brand:3,label: "Classic", image:"https://www.vistasport.ru/upload/iblock/ae1/ae1507ba15730b1caa39e3d073f3c25e.jpg", description: descriptionValue},
            {id:28, category:4, brand:2, label: "Table", image:"https://www.vistasport.ru/upload/iblock/503/503d1f2951107d75db50d7ef12f47439.jpg", description: descriptionValue},
            {id:29, category:4, brand:6,label: "Butterfly Kisa", image:"https://www.vistasport.ru/upload/iblock/810/8107cb81294806e2ed79a23fd84b4513.png", description: descriptionValue},
            {id:30, category:4, brand:2, label: "Timo Boll", image:"https://www.vistasport.ru/upload/iblock/503/503d1f2951107d75db50d7ef12f47439.jpg", description: descriptionValue},
            //Одежда
            //Butterfly
            ...
            categories:  [
              {id: 2, src: "https://www.vistasport.ru/upload/uf/dde/dde51349dd4ff63d4413ef1833d34897.svg", text: "Накладки"},
                {id:1, src: "https://www.vistasport.ru/upload/uf/02e/02e45e38fc2dbcd8f100bd646f3ceb41.svg", text: "Основания"},
                {id:4, src: "https://www.vistasport.ru/upload/uf/f38/f3813bc592911d3a0da019a6f8c21643.svg",text:"Столы" },
                {id:5, src: "https://www.vistasport.ru/upload/uf/f38/f3813bc592911d3a0da019a6f8c21643.svg",text:"Одежда" },
                {id:3, src: "https://www.vistasport.ru/upload/uf/dbb/dbb7d8113be06a0376bd47c72cc36175.svg",text:"Обувь" },
                {id:6, src: "https://www.vistasport.ru/upload/uf/dbb/dbb7d8113be06a0376bd47c72cc36175.svg",text:"Столы" }
            ],
            

            charachters:[
              { id: 1, name: "Fastest",categories:[1,2], winner:"Andro Blowfish", value: 9.5  },
              { id: 2, name: "Spin", categories:[2], winner:"Andro Blowfish", value: 9.5  },
              { id: 3, name: " Control", categories:[1,2], winner:"Andro Blowfish" , value: 9.5 },
              { id: 4, name: "Deceptive", categories:[2], winner:"Andro Blowfish" , value: 9.5 },
              { id: 5, name: "Spin Reversal	", categories:[2], winner:"Andro Blowfish" , value: 9.5 },
              { id: 6, name: "Weight", categories:[2], winner:"Andro Blowfish", value: 9.5  },
              { id: 7, name: "Hardest Sponge	", categories:[1,2], winner:"Andro Blowfish", value: 9.5  },
              { id: 8, name: "Softest Sponge", categories:[1,2], winner:"Andro Blowfish", value: 9.5  },
              { id: 9, name: "Stiffest", categories:[1], winner:"Andro Blowfish" , value: 9.5 },
              { id: 10, name: "Flex	", categories:[1], winner:"Andro Blowfish" , value: 9.5 },
              { id: 11, name: "Overall", categories:[1,3,4], winner:"Andro Blowfish", value: 9.5  },
              { id: 12, name: "Grip", categories:[3], winner:"Andro Blowfish" , value: 9.5 },
              { id: 13, name: "Comfortable	", categories:[3], winner:"Andro Blowfish" , value: 9.5 },
              { id: 14, name: "Durable", categories:[3], winner:"Andro Blowfish", value: 9.5  },
              { id: 15, name: "Weight	", categories:[3], winner:"Andro Blowfish" , value: 9.5 },
              { id: 16, name: "Bounce", categories:[4], winner:"Andro Blowfish" , value: 9.5 },
              { id: 17, name: "Spin	", categories:[4], winner:"Andro Blowfish" , value: 9.5 },
              { id: 18, name: "Surface", categories:[4], winner:"Andro Blowfish", value: 9.5  },
